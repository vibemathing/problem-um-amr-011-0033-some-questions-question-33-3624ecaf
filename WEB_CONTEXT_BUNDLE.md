...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-011-0033-some-questions-question-33-3624ecaf",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-011-0033-05b5b368a3a7",
        "url": "https://www.unsolvedmath.com/problems/AMR-011-0033"
      }
    ],
    "statement": {
      "language": "en",
      "text": "For every $k>1$, does there exist $C(k)<1$ such that the return probability of every transient $k$-regular Cayley graph is at most $C(k)$?",
      "version": 1
    },
    "title": "Some Questions — Question 33",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "6a2bffc8c8bbb5a42e01af3d4ff8ebc7384c47bb78496e5d737ba664151cbb56"
}
```
